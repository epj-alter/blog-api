  ...
  private async createTables() {
    try {
      ...
      const createUsersTable =
        'CREATE TABLE users (' +
        '_id VARCHAR NOT NULL, username VARCHAR(58) NOT NULL, password VARCHAR NOT NULL, email VARCHAR NOT NULL, public_name VARCHAR(12) NOT NULL, created timestamp DEFAULT CURRENT_TIMESTAMP,' +
        'PRIMARY KEY (_id),' +
      ...
      const createPostsTable =
        'CREATE TABLE posts (' +
        '_id SERIAL, user_id VARCHAR NOT NULL, title VARCHAR(100) NOT NULL, image VARCHAR NOT NULL, content TEXT NOT NULL, created timestamp DEFAULT CURRENT_TIMESTAMP,' +
        'PRIMARY KEY (_id),' +
      ...
      const createCommentsTable =
        ...
        '_id SERIAL, user_id VARCHAR NOT NULL, post_id INT NOT NULL, content TEXT NOT NULL, created timestamp DEFAULT CURRENT_TIMESTAMP,' +
        'PRIMARY KEY (_id),' +
        'FOREIGN KEY (user_id) REFERENCES users(_id) ON DELETE CASCADE,' +
